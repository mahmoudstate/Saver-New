...
export default function Breakdown({ store, back }) {
  ...
  return (
    <div className="content padnav">
      <div className="hero">
        <div className="toprow"><div className="hib" onClick={back}><Ico name="back" size={20} /></div><div className="ttl">Breakdown</div><div className="grow" /><div className="hchip" onClick={() => setMonthSheet(true)} style={{ background: "var(--heroChip)", color: "var(--heroText)", border: "none", cursor: "pointer" }}><Ico name="cal" size={14} /> {monthChip(vm, cm)}</div></div>
      ...
      <SegToggle style={{ marginBottom: 16 }} value={mode} onChange={setMode} options={[{ id: "expense", label: "Spending" }, { id: "income", label: "Income" }]} />
